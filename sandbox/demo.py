...
def demo_current_weather(save_to_db: bool = False):
...
def demo_weather_forecast(save_to_db: bool = False):
...
def demo_weatherapi(save_to_db: bool = False):
    current_weather = demo_current_weather(save_to_db=save_to_db)
    weather_forecast = demo_weather_forecast(save_to_db=save_to_db)
